...
?>
	<div class="col-xs-12">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><input class="form-control" name="calcular" type="number" id="calcular" 
					placeholder="Escribe la cantidad" value="<?php echo $producto->cantidad
					?>" ></td>
		...
		<form action="../includes/terminarVenta.php" method="POST">
			...
			<a href="../includes/cancelarVenta.php" class="btn btn-danger">Cancelar venta</a>
		</form>
	</div>
